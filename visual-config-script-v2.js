(function() {
    try {
        ...
        document.addEventListener('click', (e) => {
            ...
            const eventId = suggestedName + '_' + Date.now();
            ...
            const eventData = {
                ...
                payload: {
                    selector: selector,
                    eventId: eventId,
                    elementText: (target.innerText || target.value || '').trim().slice(0, 50)
                }
            };
        ...
        console.error('Erro no script de configuração visual:', error);
    }
})();
